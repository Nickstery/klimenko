                ...
                <form action="/register" method="POST">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="affiliation" class="form-control" id="affiliation" name="affiliation" placeholder="Affiliation">
                    </div>
                    <div class="form-group">
                        <label for="affiliation_home">Address of Affiliation:<span style="color:red"><font size="4">*</font></span></label>
                        <input type="affiliation_home" class="form-control" id="affiliation_home" name="affiliation_home" placeholder="Address of Affiliation">
                    </div>
                    <div class="from-group">
                        <label for="status">Status:<span style="color:red"><font size="4">*</font></span></label>
                        <select type="status" class="form-control" id="status" name="status" placeholder="Status">
                    ...
                    <div class="from-group">
                        ...
                        <select type="talk" class="form-control" id="talk" name="talk" placeholder="Talk">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date_arrival" class="form-control" id="date_arrival" name="date_arrival" placeholder="Date of arrival">
                    </div>
                    <div class="form-group">
                        <label for="date_departure">Date of departure:<span style="color:red"><font size="4">*</font></span></label>
                        <input type="date_departure" class="form-control" id="date_departure" name="date_departure" placeholder="Date of departure">
                    </div>
                    <div class="from-group">
                        <label for="dinner">Do you want to participate in the conference dinner? <span style="color:red"><font size="4">*</font></span></label>
                        <select type="dinner" class="form-control" id="dinner" name="dinner" placeholder="Dinner">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div></br>
                    <div class="from-group">
                        ...
                        <select type="accom" class="form-control" id="accom" name="accom" placeholder="Accommodation">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div></br>
